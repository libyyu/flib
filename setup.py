...
if os.path.exists('README.rst'):
    with open('README.rst') as f: kwargs['long_description'] = f.read()
...
setup(
    name="flib",
    version=version,
    namespace_packages = [ 'flib' ],
    packages=["flib","flib.tools", "flib.chardet"],
    author="lidengfeng",
    author_email="libyyu@qq.com",
    url="http://www.zulong.com/",
    license="PWRD",
    description="zl seven python tools",
    **kwargs
)
